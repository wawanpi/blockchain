...
<body class="bg-gray-50 text-gray-800 antialiased relative selection:bg-minang-red selection:text-white" x-data="{ mobileMenuOpen: false, scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)">
    ...
    <header :class="scrolled ? 'bg-white/95 backdrop-blur-md shadow-md py-2' : 'bg-transparent py-4'" class="fixed top-0 w-full z-50 transition-all duration-300">
        <nav class="container mx-auto px-4 lg:px-8 flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                {{-- UPDATE 1: Link Home ke route welcome --}}
                <a href="{{ route('welcome') }}" :class="scrolled ? 'text-gray-600 hover:text-minang-red' : 'text-white hover:text-minang-gold'" class="font-semibold text-sm uppercase tracking-wider transition-colors shadow-sm">Home</a>
                ...
                {{-- UPDATE 2: Link About ke route about --}}
                <a href="{{ route('about') }}" :class="scrolled ? 'text-gray-600 hover:text-minang-red' : 'text-white hover:text-minang-gold'" class="font-semibold text-sm uppercase tracking-wider transition-colors shadow-sm">About</a>
            </div>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="flex-1 overflow-y-auto p-5 space-y-4">
            <a href="{{ route('welcome') }}" class="block text-gray-700 font-semibold hover:text-minang-red">Home</a>
            <a href="#menu" class="block text-gray-700 font-semibold hover:text-minang-red">Menu Pilihan</a>
            
            {{-- UPDATE 3: Menambahkan Menu About di Mobile --}}
            <a href="{{ route('about') }}" class="block text-gray-700 font-semibold hover:text-minang-red">Tentang Kami</a>
