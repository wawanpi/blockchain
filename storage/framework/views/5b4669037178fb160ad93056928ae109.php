        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <?php if(session('danger')): ?>
                <div class="mb-6 p-4 rounded-2xl bg-red-50 border border-red-100 text-red-800 shadow-sm flex items-center gap-4 animate-pulse">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-red-600"><?php echo e(session('danger')); ?></p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8" 
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <form action="<?php echo e(route('admin.transaksi.globalAudit')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors group">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center gap-2">
                                                    <a href="<?php echo e(route('admin.transaksi.audit', $transaksi->id)); ?>"
                                                       class="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors text-xs font-bold border border-blue-100"
                                                       title="Cek Integritas Blockchain">
                                                        <i data-lucide="shield-check" class="w-3 h-3"></i> Audit
                                                    </a>
                                                </div>
                                            </td>
...
<?php endif; ?><?php /**PATH D:\blocchain-burmin\resources\views/admin/transaksi/index.blade.php ENDPATH**/ ?>